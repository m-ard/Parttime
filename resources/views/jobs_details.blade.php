                  ...
                  <div class="col-xl-7 col-lg-8">
                     ...
                     <div class="single-job-items mb-50">
                        <div class="job-items">
                           ...
                           <div class="job-tittle">
                              <a href="#">
                                 <h4>{{ $vacancy[0]->posisi }}</h4>
                              </a>
                              <ul>
                                 <li>{{ $vacancy[0]->nama_perusahaan }}</li>
                                 <li><i class="fas fa-map-marker-alt"></i>{{ $vacancy[0]->lokasi }}</li>
                                 <li>{{ 'Rp '.number_format($vacancy[0]->gaji, 2, ',', '.') }}</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="job-post-details">
                        ...
                        <div class="post-details2  mb-50">
                           ...
                           <ul>
                              <li>Memahami Ilmu Advertising, Media dan Komunikasi, Digital Marketing, Jurnalistik, Hubungan Masyarakat dan Manajemen Bisnis</li>
                              <li>Pengetahuan tentang metode pengoptimalan mesin telusur (SEO) dan 'kunci' atau 'mencari' kata-kata untuk mengarahkan lebih banyak pengguna ke situs media sosial</li>
                  ...
                  <div class="col-xl-4 col-lg-4">
                     <div class="post-details3  mb-50">
                        ...
                        <div class="apply-btn2 centered text">
                           <a href="/job_details2" class="btn">Apply Now</a>
                           <a href="https://api.whatsapp.com/send/?phone={{ $vacancy[0]->no_perusahaan }}&text&type=phone_number&app_absent=0" class="btn">Contact</a>
                        </div>
                     </div>
