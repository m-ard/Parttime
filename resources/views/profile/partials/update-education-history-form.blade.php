...
<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="nama_sekolah" :value="__('School Name')" />
        ...
        <div>
            <x-input-label for="tingkatan" :value="__('Grade (e.g. SD/SMP/SMA/etc.)')" />
        ...
        <div>
            <x-input-label for="tahun_keluar" :value="__('Graduation Year')" />
